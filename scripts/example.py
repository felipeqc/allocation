...
import sys
import pickle
import alloc_alg_himeov as himeov
...
s = hime.HimeTaskSet(5)
#s = himeov.HimeTaskSetOv(4, overhead, cpmd)
s.setVerbose(True)
...
#<properties hyperperiod="185640" utilization="3.60000000" />
"""s.createTask(2.60073401,3)
s.createTask(26.92368827,56)
s.createTask(0.21927224,2)
s.createTask(3.49050533,5)
s.createTask(25.21105780,34)
s.createTask(0.07828768,3)
s.createTask(35.20263429,52)"""
...
#P1= tau_1, \tau^1_6=(0.5-e, 1.5)
#P2= tau_2, \tau^2_6=(0.5-e, 1.5)
#P3= tau_7, \tau^2_6=(0.25+2e, 1.5)
#P4= tau_3, \tau^1_5=(1-2e, 2)
#P5= tau_4  \tau^2_5=(4e,2)
